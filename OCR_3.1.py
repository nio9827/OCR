    ...
    with open(pdf_path, "rb") as file:
        ...
        for page_num in range(len(pdf_reader.pages)):
            ...
            images = convert_from_path(
                pdf_path, dpi=300, first_page=page_num + 1, last_page=page_num + 1
            )
...
for filename in os.listdir(carpeta_pdf):
    if filename.endswith(".pdf"):
        ...
        if coincidencias:
            ...
            # Llama a la función para extraer texto del PDF
            extracted_text = extract_text_from_pdf_2(pdf_path)
            ...
            print("No se encontró ningún número en el texto_1")